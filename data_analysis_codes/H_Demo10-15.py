...
df = pd.read_csv(r"C:\Users\mishr\AppData\Local\Packages\5319275A.WhatsAppDesktop_cv1g1gvanyjgm\LocalState\sessions\08ACFD25CA4485B9F21F5341C0C2DB8A62030E04\transfers\2026-03\api_data_aadhar_demographic_1000000_1500000.csv")
print("#Head")
print(df.head())
print("#info")
print(df.info())
